/*+- SVN Keywords ----------------------------------------------------+
 *|                                                                   |
 *| $HeadURL:: svn+ssh://dkoszkul@panamint.iiar.pwr.wroc.pl/home/dk#$:|
 *|     $Rev:: 27                                                   $:|
 *|    $Date:: 2014-10-26 15:28:23 +0100 (nie)                      $:|
 *|  $Author:: dkoszkul                                             $:|
 *|                                                                   |
 *+-------------------------------------------------------------------+
 */
...
class LaczeDoGNUPlota {
 ...
 public:
  ...
  void WyswietlajKomunikatyBledow( bool Tryb = true );
    ...
    * \param  RodzRys - określa sposób rysowania linii. Dostępne są
  ...
  /*!
   * \brief Usuwa wskazaną nazwę pliku
   *
   * Usuwa wskazaną nazwę pliku
   */
  void UsunNazwe(std::string nazwa);
